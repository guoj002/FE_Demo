...
function c(t) {
    ...
    for (v in t) {
        switch (v) {
            case "title":
                i = t[v].replace(/<[^<>]+>/g, ""), i && i.length > 100 && (i = i.substring(0, 100)), i = encodeURIComponent(i);
                break;
            case "mu":
            case "url":
                i = escape(t[v]);
    ...
    if (window.bds && bds.comm) {
        ...
        c += "&rsv_ssl=" + ("https:" === location.protocol ? 1 : 0), c += "&path=" + encodeURIComponent(n), c += "&rsv_did=" + (bds.comm.did ? bds.comm.did : ""), s.src = c
    }
    return !0
}
...
function setHeadUrl(t) {
    ...
    var n = t.href;
    n = n.replace(new RegExp("(" + t.getAttribute("wdfield") + "=)[^&]*"), "$1" + e), t.href = n
}
...
function initPreload(t) {
    ...
    function s(t) {
        var e, n, o, i, r = {};
        t.indexOf("?") > -1 ? (o = t.split("?"), i = o[1]) : i = t, e = i.indexOf("&") > -1 ? i.split("&") : new Array(i);
        for (var s = 0; s < e.length; s++) try {
            e[s] = e[s].indexOf("=") > -1 ? e[s] : e[s] + "=", n = e[s].split("="), r[n[0]] = decodeURIComponent(n[1].replace(/\+/g, " "))
        } catch (a) {}
        return r
    }
    ...
    function a(t) {
        ...
        function o() {
            ...
            Cookie.set("rsv_jmp_slow", e), Cookie.set("WWW_ST", e, null, null, new Date(e + 3e4)), t = ne.href + (ne.href.indexOf("?") > 0 ? "&" : "?") + "rsv_jmp=slow", ne.replace(t)
        }
        if (!V) {
            var t = $.extend({
                    top: 93,
            ...
            B || (B = $("<div id='_mask'/>")), B.css({
                ...
                top: t.top + "px",
                left: "0"
            }), V = !0, B.width(Ye.width()), B.height(Math.max(i, Ye.height()) - t.top), B.appendTo(Ye), $(window).scrollTop(), F = setTimeout(n, 3e3), G = setTimeout(o, 7e3), Q = function() {
                F && (clearTimeout(F), F = setTimeout(n, 3e3)), G && (clearTimeout(G), G = setTimeout(o, 7e3))
            }
        }
    }

    function d() {
        B && V && (V = !1, B.remove(), H && H.remove(), F && (clearTimeout(F), F = !1), W && W.remove(), G && (clearTimeout(G), G = !1))
    }
    ...
    function u(t, e, n) {
        ...
        }, "insertBefore" == n ? e.insertBefore(t) : t.append(e), window.currentScriptElem = void 0, $.globalEval = r
    }
    ...
    function m(t) {
        try {
            ...
            window.console && console.debug && console.debug(e), J(e.toString())
        }
    }
    ...
    function p(t, e) {
        ...
        if (!p.__init) {
            ...
            p.prototype.clone = function(t) {
                ...
                for (var n in this.header_params)
                    if ("object" == typeof this.header_params[n]) {
                        ...
                        for (var i in this.header_params[n]) {
                            ...
                            r instanceof Array && (r = r.join("|")), o.push(i + "=" + r)
                        }
                        e[n] = o.join("&")
                ...
                return l(r, t) >= 0 && (t = "wd"), void 0 === e ? this.params[t] : (this.params[t] = e, this)
        ...
        if (this.params = {}, !e) {
            ...
            for (var s = 0; s < je.length; s++) this.p(je[s].name) || this.p(je[s].name, je[s].value)
        }
        if ("object" == typeof t)
    ...
    function f(t) {
        ...
        function m() {
            var t = Math.random(),
                e = /21307|21306|21340|21339|23752|23753|23754|23755|23756|23757|23758|25667|25668|25745|25746/,
                r = t > .51 && .52 > t;
            S = S || bds.comm.bfe_sample;
            var s = S && t > .6 && .9 > t;
            if (t > .51 && .52 > t || e.test(bds.comm.sid) && t > 0 && .2 > t || bds.comm.intrSid || s) {
                e.test(bds.comm.sid) && (r ? n("issam", 2) : n("issam", 1)), s && (n("issam", 3), n("bfesam", bds.comm.bfe_sample)), o(), h(C), g(C), n("srvInfo", f()), n("sysv", navigator.appMinorVersion), a(), x.fire();
        ...
        function p(t) {
            C = t, t.find("img").one("load", function() {
                var t = $(this).offset(),
                    o = t.top,
                    i = t.left,
                    r = "";
                if (I > o && o > 0) {
                    e("fs");
                    var s = _.fs - _.dom;
                    y.push(o + "_" + i + "_" + s), r = $(this).attr("data-src") || /^http/.test($(this).attr("src")) ? $(this).attr("data-src") || $(this).attr("src") : "base64", n("ic_lis", r)
                }
            })
        }
        ...
        function h(t) {
            for (var e = 0, o = t.find("img"), i = t.find("#content_left").find("img"), r = 0, s = 0, a = 0; a < o.length; a++) s = o.eq(a).offset().top, I > s && s > 0 && e++;
            n("cus_ic", o.length), n("cus_extic", e), n("cus_extlic", r), n("cus_icl", i.length), n("cus_icr", t.find("#content_right").find("img").length), n("img_info", y.join(",")), n("psize", t.html().length)
        }
        ...
        function g(t) {
            var e = {},
                ...
                r = "";
            if (i.length > 0)
                for (var s = 0; s < i.length; s++) r = i.eq(s).attr("tpl"), e.hasOwnProperty(r) || (e[r] = 1, o.push(r));
                    ...
                    function t() {
                        ...
                        for (var r in n) ! function(e) {
                            var r = "_SSL_LOG_" + e + "_" + +new Date,
                                s = new Image,
                                a = new Date;
                            i[e] = $.Deferred(), o.push(i[e]), s.onload = function() {
                                t.push(e + "_success=" + (new Date - a)), i[e].resolve(), delete window[r]
                            }, s.onerror = function() {
                                t.push(e + "_error=" + (new Date - a)), i[e].resolve(), delete window[r]
                            }, s.src = n[e]
                        }(r);
                        var s = $.when.apply($, o);
                        s.always(function() {
    ...
    function _(t) {
        if (!window.__disable_is2 || $.trim(t) != $.trim($e.val())) {
            if (Ze || !bds.comm.supportis) return void(ke && ke.html(""));
            if (0 != pageState && !window.__disable_kw_tip)
                if (ke || (ke = $('<div id="kw_tip" style="width:initial" unselectable="on" onselectstart="return false;" class="s_ipt_tip"/>').insertBefore($e), ke.parent().click(function(t) {
                        var e = $e.get(0);
                    ...
                    }).text(t), window.__disable_is2 && ke.css("z-index", 1), ke.show()
                } else ke.hide()
        }
    }
    ...
    function x() {
        Ze = !0, ze && ze.real_wd && $.trim($e.val()) ? (_(ze.real_wd), k(ze)) : (_(""), k())
    }
    ...
    function T(t, e) {
        ...
        Ae.hide(), oldEnv = Me, Me = t, He = ze, ze = e, bds.comm.cur_disp_query = t.p("wd"), S(), bds && bds.se && bds.se.certification && bds.se.certification.data && (bds.se.certification.data = []), 0 == pageState && N(t), m(function() {
            he()
        }), bds.clearReady(), Ae.empty();
        var i = e.html;
        if (X.use_cache_repeatedly && (i = i.clone()), m(function() {
        ...
        ! function() {
            ...
            if (o.size())
                if (t.children().size()) {
                    ...
                    o.attr("cq") != r.attr("cq") || o.attr("srcid") != r.attr("srcid") || e.force && oldEnv && oldEnv.equals(Me) || !Me.p("cq") || !Me.p("srcid") || 1 == Me.p("_trf") ? (n.remove(), $(window).trigger("top_result_removed"), u(Ae, t, "insertBefore")) : s = !0
        ...
        m(function() {
            ...
            i && $.globalEval(i.find("#jsMerge").html()), h(e, {
                jsmergetime: (new Date).getTime() - t
            })
        }), bds && bds.comm && bds.comm.templateName == bds.comm.resTemplateName ? bds.comm.seinfo && (bds.comm.seinfo.rsv_tpfail = 0) : bds.comm.seinfo && (bds.comm.seinfo.rsv_tpfail = 1), 0 != pageState && bds && bds.util && bds.util.setContainerWidth && bds.util.setContainerWidth(), document.title = t.p("wd") + "_百度搜索", Ae.show(), d(), h(e, {
            domtime: (new Date).getTime() - n
        }), h(e, {
            waittime: (new Date).getTime() - Te
        }), e.pdc.mark("dom"), $(window).trigger("swap_dom_ready", [e, t]), window.__lazy_foot_js ? setTimeout(function() {
            C(t, e, n)
        }, 0) : C(t, e, n), s ? window.scrollTo(o[0], o[1]) : window.scrollTo(0, 0), $(window).trigger("scroll"), swap_wait = !1
    }

    function C(t, e, n) {
        var o;
        n || (n = 0), e && (o = e.html), m(function() {
            _e.get(0).f.value = 8
        }), m(function() {
            var t = (new Date).getTime();
            e && e.base64 && (e.base64.setDomLoad("left"), e.base64.setDomLoad("right")), h(e, {
            ...
            var t = (new Date).getTime();
            o && $.globalEval(o.find("#ecomScript").html()), h(e, {
            ...
            bds.se.tools && (Ie && clearTimeout(Ie), Ie = setTimeout(function() {
                bds.se.tools()
            }, 600)), bds && bds.se && bds.se.certification && bds.se.certification.build && (Se && clearTimeout(Se), Se = setTimeout(function() {
                $(".certification").size() > 0 && bds.se.certification.build.init()
            }, 1e3)), bds && bds.se && bds.se.safeTip && (Ce && clearTimeout(Ce), Ce = setTimeout(function() {
            ...
            $(window).trigger("swap_end", [e, t]), O(), qe = (new Date).getTime(), e && e.pdc && (e.pdc.mark("js"), e.pdc.trigger("swap_end"))
        })
    }
    ...
    function D(t, e, n) {
        return function(e) {
            var o = $.extend({}, e);
            if (t && !t.confirm) {
                bds.comm.cur_query = t.real_wd, !bds.comm.supportis && t && (n = t.pstg || 0), t.confirm = !0, De = !1, Re = null;
                var i = {};
                i.is_referer = oe, i.is_xhr = "1";
                var r = new p(s(ie.getQueryString()), !0);
                t.env.equals(r) || t.env.clone({
                    wd: t.prw
                }).equals(r) || ie.setUrl(t.env), oe = ne.protocol + "//" + ne.host + ne.pathname + ne.search, t.seq ? t.seq++ : t.seq = 1, t.pdc && (20 != n && bds.comm.supportis && t.pdc.mark("st"), t.pdc && t.pdc.setParam && t.pdc.setParam("cus_pstg", n), t.force && t.pdc.setParam("f4s", 1), t.pdc.trigger("confirm"), window.PRE_CONN.startTimer()), m(function() {
                ...
                if (bds.comm.indexSid && (/9998_/.test(bds.comm.indexSid) && "https:" === ne.protocol && (bds.comm.indexSid = bds.comm.indexSid.replace("9998", "8499")), a += "&rsv_isid=" + bds.comm.indexSid), t.no_predict && (a += "&isnop=" + (1 >= fe ? 0 : 1)), t && t.pstg && (a += "&isctg=" + t.pstg), fe = 0, Ue && Ue.getRsvStatus) try {
                    a += "&rsv_stat=" + Ue.getRsvStatus(t.env.p("wd"))
                } catch (c) {}
                if (Fe.done(function() {
                        Ue.getStat("rsv_sug6") && (a += "&rsv_sug6=" + Ue.getStat("rsv_sug6"), bds.comm.seinfo && (bds.comm.seinfo.rsv_sug6 = Ue.getStat("rsv_sug6"))), Ue.getStat("rsv_sug7") && (a += "&rsv_sug7=" + Ue.getStat("rsv_sug7")), Ue.getStat("rsv_sug9") && (a += "&rsv_sug9=" + Ue.getStat("rsv_sug9")), Ue.getStat("rsv_bp") && (a += "&rsv_bp=" + Ue.getStat("rsv_bp"))
                    }), $.ajax({
                        headers: i,
                        url: a
                    }).done(function(t) {
                    ...
                    bds.comm.seinfo.rsv_prw = encodeURIComponent($e.val()), bds.comm.seinfo.rsv_pstg = n, bds.comm.seinfo.rsv_svoice = window.__supportvoice ? "1" : "0", t.cftime += 1, bds.comm.cftime = t.cftime + "";
                    var d = t.env.p("rsv_bak");
                    d && (bds.comm.seinfo.rsv_bak = d)
                }
                bds.comm.confirmQuery = bds.comm.query, bds.comm.confirmQid = bds.comm.qid, g(), ve = t.qid, Fe.done(function() {
                    20 == n ? Ue.updateInitData() : 22 == n || bds.comm.supportis || n >= 0 && 5 >= n && Ue.updateInitData(), Ue.clearStat()
    ...
    function R(t) {
        ...
        en = !0, tn = setTimeout(function() {
            en = !1
        }, 1e3);
        try {
            var e = $("#kw").attr("placeholder") || $(".kw-placeholder").text();
            if (!$.trim($e.val()) && !e) return ne.href = "/", !1;
            var n, o = new p,
                i = $(this).serializeArray();
            for (n = 0; n < i.length; n++) o.p(i[n].name, i[n].value);
            if (e && !$.trim($e.val()) ? (o.p("wd", e), o.p("rsv_dq", 1)) : $.trim($e.val()) && o.p("wd", $e.val()), o.p("nojc") && o.p("nojc", ""), ze) {
                if (o.equals(ze.env.clone({
                        wd: ze.real_wd
                    })) && !ze.force) return D(ze, He, 22)(), ze.force = !0, _(""), k(ze), !1;
                ze.env.p("rsv_spt") && o.p("rsv_spt", ze.env.p("rsv_spt"))
            }
            ie.submit(o, !!t)
        } catch (r) {}
        return !1
    ...
    function A(t) {
        ...
        if (o && o.p("wd") && o.hashCode() && (!re && 1 != Cookie.get("ISSW") || i || !r) && (!ae && 1 != Cookie.get("ISSW") || i || r)) {
            if (c && (n = ee.hasCache(o, {
                    loaded: !0
                }))) return void(s && (ze && n.env.clone({
                wd: n.real_wd
            }).equals(ze.env.clone({
                wd: ze.real_wd
            })) || (n.force = e.force, n.no_predict = e.no_predict, n.pdc.init(), n.force && (n.pdc.mark("st"), window.bds && bds.comm && !bds.comm.supportis && (n.pdc.mark("net"), n.pdc.setParam("cus_hitpreload", 1))), T(o, n)), _(e.no_predict && 6 != e.pstg ? "" : n.real_wd), k(n)));
            i && s && r && a(), n = {
                env: o,
                cftime: 0,
                no_predict: r,
            ...
            }, n.pdc = f(n), e.pstg > 0 && (n.pstg = e.pstg), n.force && n.pdc.mark("st"), n.base64 = isbase64(n.pdc), Le.push(n.log), pe++, fe++, U(n)
        }
    }
    ...
    function j(t) {
        e(), ne.replace(t.buildSyncSearchUrl())
    }

    function q(t, e) {
        e ? (ae = !0, rn && (clearTimeout(rn), rn = !1), rn = setTimeout(function() {
            ae = ce
        }, t)) : (re = !0, on && (clearTimeout(on), on = !1), on = setTimeout(function() {
            re = se
        }, t))
    }
        ...
        if (!(1 == d && 1 == l || 11 == d && 3 == l || 11 == d && 6 == l || 1 == d && 4 == l)) {
            ...
            if (!(t.no_predict && !t.force && (s = ee.find(function(t) {
                ...
                if (t.force && t.shouldShow) {
                    ...
                    for (e = 0; e < s.length; e++) ee.deleteCache(s[e])
                }
                var g, b = function(e, n, o) {
                        if (0 == n) v(e, o), t.pdc && (t.pdc.setParam("cus_srv", bds.se.mon.srvt), t.pdc.setParam("bsi", Cookie.get("__bsi")));
                        else if (1 == n) try {
                            var i = 1 * new Date;
                            t.b64ildata = $.parseJSON(e), t.base64.ilparseTime = 1 * new Date - i, t === ze && (t.base64.inline(t.b64ildata), t.base64.ilrenderTime = 1 * new Date - i), $(t).one("swap_begin", function() {
                                this.base64.inline(this.b64ildata, this.html.get(0))
                            })
                        } catch (r) {} else 2 == n && t.base64 && (t.base64.ilsum = e)
                    },
                    v = function(e, r) {
                        if (r && "302" == r.status || e && $.trim(e).indexOf("<div>") > 10) return void(t.force ? (n(11), j(a)) : ee.deleteCache(t));
                        h(t, {
                        ...
                        var s, c = "<!--data-->",
                            d = e.indexOf(c);
                        if (-1 != d) {
                            s = $(e.substr(0, d)), t.html = e.substr(d + c.length), window.__dom_pre_parse && "1" == s.find("#__need_parse_dom").html() && (t.html = $(t.html));
                            try {
                        ...
                        t.real_wd = s.find("#__real_wd").eq(0).text(), t.real_wd_org = s.find("#__real_wd_org").eq(0).text(), t.real_wd_nosynx = s.find("#__real_wd_nosynx").eq(0).text(), t.env && t.env.p("nojc") && t.real_wd_nosynx && (t.real_wd = t.real_wd_nosynx);
                        var b = !1;
                        (a.p("wd") == i($e.val()) || t.force) && t.shouldShow && (b = !0), t.real_wd && (t.prw = a.p("wd"), a.p("wd", t.real_wd));
                        var v = s.find("#__queryId").html(),
                            w = s.find("#__querySign").html();
                        t.querySign = w, h(t, {
                            stat: m ? m : 0
                        }), bds.comm.isDebug && $("#isDebugInfo").html(s.find("#__isDebugInfo").html()), v && (t.qid = v);
                        ...
                        if (p > 0 && q(1e3 * p, !t.no_predict), -11 == m) {
                            ...
                            S.force = t.force, y(), _(S.real_wd), k(S), ee.deleteCache(t), t = S, ze && t.real_wd == ze.real_wd || (b = !0)
                        } else {
                            if (0 > m) {
                        ...
                        return t.backup_request_timeout && clearTimeout(t.backup_request_timeout), t.loaded = !0, bds.comm.supportis || b ? void((b && t !== ze || t.force) && (y(), t.shouldShow = !1, -11 == m ? t.pdc.init() : t.pdc.mark("net"), T(a, t))) : !0
                    };
                g = $.ajax({
                    dataType: "parts",
                    url: m,
                    headers: c,
                    delimiter: "</*3*/>"
                }), g.parts(function(t, e) {
                    b(t, e, g)
                }), g.fail(function(e, o) {
                    t.force && t.shouldShow && "abort" != o && t.env && (n(12), ne.replace(t.env.buildSyncSearchUrl() + "&rsv_jmp=fail")), ee.deleteCache(t)
                }), t.xhr = g, ee.addCache(t)
            }
        }
    }

    function O() {
        Le = [], pe = 0, en = !1, clearTimeout(tn)
    }

    function E() {
        window.index_off && window.index_off(), xe[0] !== ye[0] && xe.val(""), $e = ye, pageState = 1, bds.comm.ishome = 0, bds.comm.cur_query = bds.comm.query, Me = new p, ze = {
            env: Me,
    ...
    function N(t) {
        window.index_off && window.index_off(), xe.get(0) !== ye.get(0) && (xe.val(""), ye.val(t.p("wd"))), $e = ye, pageState = 1, bds.comm.ishome = 0, Fe.done(function() {
            Oe !== Ee && (Oe.stop(), Ee.hide(), Ee.setKey(t.p("wd")), Ee.start())
    ...
    document.write = document.writeln = function() {}, bds && bds.comm && "clearissw" == bds.comm.query && Cookie.clear("ISSW"),
        function() {
            ...
            return t ? t && !e && Me ? Me.p(t) : void(t && e && Me && (Me.p(t, e), ne.href = Me.buildSearchUrl())) : void 0
        };
    var B, H, F, W, G, Q, V = !1;
    ! function() {
        var t = $.globalEval;
    ...
    window.setSugKey = function(t) {
        $e && t && (Ee && Ee.setKey ? Ee.setKey(t) : $e.val(t))
        ...
        $(".c-fanyi-abstract", t).val(0).html(n.html()), $(".c-fanyi-title", t).val(0).html(e.html()), e.html(i), n.html(o)
    }));
    var X = {
        ...
        ee = function() {
            ...
            return {
                ...
                hasCache: function(t, n) {
                    function o(t) {
                        var o, i;
                        return (i = t.p("wd")) ? ($.grep(e, function(e) {
                    ...
                    n || (n = {});
                    var i = o(t);
                    return i && (new Date).getTime() - i.startTime > Y && (this.deleteCache(i), i = null), i
                },
                ...
                addCache: function(n) {
                    if (-1 == l(e, n) && !n.env.p("srcid") && !n.env.p("cq"))
                        for (e.unshift(n); e.length > K;) t(e.pop())
                },
    ...
    ! function() {
        ...
        function r(t) {
            ...
            e.hashCode() ? 0 == pageState && N(e) : 0 != pageState ? ne.replace(ne.pathname + ne.search.replace(/([?&])isidx=[^&*]&?/, "$1")) : ne.search != ne.search.replace(/([?&])isidx=[^&*]&?/, "$1") && ne.replace(ne.pathname + ne.search.replace(/([?&])isidx=[^&*]&?/, "$1")), ie.onurlchange(e, t)
        }
        var a = "onhashchange" in window,
            c = "onpopstate" in window;
        window.__disable_popstate && (c = !1);
        var l = ne.pathname.length > 1 ? ne.pathname : "/s";
        (navigator.userAgent.match(/MSIE (6|7)/) || document.documentMode < 8) && (a = !1, c = !1), X.disable_popstate && (c = !1), a || c || e();
        var u = function() {
            var e = "";
            return function(n, o) {
                o && (e = o.buildQueryString(), ne.hash = e), (n || e != t()) && (r(n), e = t())
            }
        }();
        ...
        var m = function() {
            var t = n();
            return function(e, o) {
                o && (t = o.buildQueryString(), window.history.pushState(o, "", o.buildSyncSearchUrl())), e || t != n() ? (r(e), t = n()) : d()
            }
        }();
        ...
        Fe.done(function() {
            Ue.setKey(t.p("wd")), Ue.hide()
        }), Te = (new Date).getTime(), $e.val(t.p("wd")), _("");
        var n = !0;
        e && ze && ze.env && ze.env.equals(t) && (n = !1), A({
            env: t,
            force: !0,
            use_cache: n,
            no_predict: !0
    ...
    de || (de = window.__switch_add_mask ? window.__switch_add_mask : !1), de = !0;
    ...
    ie.support() || (! function() {
        ...
        ne.hash.match(/[^a-zA-Z0-9](wd|word)=/) ? (ne.replace("//www.baidu.com/s?" + ne.href.match(/#(.*)$/)[1]), function() {
    ...
    var we, _e, ye, xe, $e, ke;
    ye = xe = $e = $(X.kw);
    var Te, Ce, Se, Ie, De, Re, Ae = $("#wrapper_wrapper"),
        Le = [];
    window.__async_strategy, we = $(X.index_form), "_blank" == we.attr("target") && (window.__disable_index_predict = !0, se = re = !0);
    var je = we.serializeArray();
    _e = $(X.result_form);
    var qe = (new Date).getTime();
    window.pageState = 0;
    var Ue, Oe, Ee, Ne, Pe, Me = null,
        ze = null,
        ...
        Fe = $.ajax({
            dataType: "script",
            cache: !0,
            url: 1 === bds.comm.logFlagSug ? "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/sug/js/bdsug_async_sam_sug_efdbf72.js" : "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/sug/js/bdsug_async_68cc989.js"
        }),
        We = "focus";
    ! function() {
        window.PDC_ASYNC = {
                ...
                var e = new Date,
                    ...
                    r = function() {
                        var n = new Date,
                            l = n - e - t,
                            u = o();
                        0 > l && (l = 0), u || i || (s[a] = l, a = (a + 1) % 20), i = u, 1 == c && (e = n, d = setTimeout(r, t))
                    };
                d = setTimeout(r, t)
            }
        }
    ...
    Fe.done(function() {
        Ue = Oe = Ee = bds.se.sug({
            ...
            (9 == t.keyCode || 39 == t.keyCode && e == this.value.length) && bds.comm.supportis && ze && ke.text() && (t.preventDefault(), ze.real_wd != this.value && ($e.val(ze.real_wd), Ue.check()), Ue.show(), _(""), D(ze, He, 22)({
                tipConfirm: !0
            }))
        ...
        Ue.on("inputChange", function(n, o) {
            if (!(window.__sam_his_nopredict && window.bds && bds.comm && 0 == bds.comm.supportis)) {
                if (t || (t = $e.val()), _(""), P(), clearTimeout(Qe), clearTimeout(sn), 0 == pageState && window.__disable_index_predict || re || ae || Ge.isSlow()) return void Ue.setMaxNum(10);
                Ue.setMaxNum(te);
                var i = new p({
                    pn: "",
                    wd: o.value
                ...
                if (window.__restart_confirm_timeout && I(), We = "input", Te = (new Date).getTime(), e && (clearTimeout(e), e = !1), "" == $.trim(o.value)) return void x();
            ...
            if (_(""), clearTimeout(Qe), !(0 == pageState && window.__disable_index_predict || re || ae || Ge.isSlow()))
                if (-1 == n) {
                    ...
                    bds && bds.comm && bds.comm.logFlagSug && 1 === bds.comm.logFlagSug && i.p("rsv_slog", "sug_select"), A({
                        env: i,
                        use_cache: !0,
                        force: !1,
                        shouldShow: bds.comm.supportis,
    ...
    ! function() {
        ...
        Ve = function(e) {
            if (e) {
                s = e.pageX, a = e.pageY, t = e.target;
                var r = $(e.target);
                "submit" == r.attr("type") && (c = 1);
                var d = r.offset();
                o = s - d.left, i = a - d.top, n = (new Date).getTime()
            }
        }, Je = function(o) {
            ...
            if (!e.attr("target") || "_self" == e.attr("target")) {
                ...
                if (n && 0 == n.indexOf(t) && (n = n.substring(t.length)), n && (matched = n.match(/^\/*s\?(.*)/)), n && matched) {
                    ...
                    if (o.pn || (o.pn = ""), l(["baidurt", "baiduwb", "baidufir", "SE_baiduxueshu_c1gjeupa"], o.tn) < 0) {
                        ...
                        var r = ie.clickResultLink(e, Me, o)
                    }
                    return r
                }
            }
    ...
    $(window).on("swap_dom_ready", function(t, e) {
        var n = "";
        !e || !e.real_wd || e.no_predict && 6 != e.pstg || (n = e.real_wd), _(n), k(e)
    }), $(window).on("swap_end", function(t, e) {
        e && (window.cfpromise = new $.Deferred, De && (clearTimeout(De), De = !1, Re = null), e.confirm = !1, e.force ? D(e, He, 20)() : (Re = D(e, He, 21), De = setTimeout(Re, Z)))
    }), $(window).on("indexOff", function(t, e) {
        Fe.done(function() {
            _(e.p("wd"))
        })
    }), ie.support() && "_blank" != we.attr("target") && Fe.done(function() {
        Ue.setMaxNum(te)
    });
    var tn, en = !1,
        nn = !1;
    ...
    var on, rn, sn;
    $(window).on("swap_end", function(t, e) {
        e || (bds.comm.confirmQuery = bds.comm.query, bds.comm.confirmQid = bds.comm.qid, g()), sn = setTimeout(function() {
    ...
    }), bds.comm.resultPage && E(), Ye.delegate("#s_tab a", "mousedown", function() {
        setHeadUrl(this)
    ...
    Fe.done(function() {
        ...
        var t = new Date;
        t.setTime((new Date).getTime() + 110376e7), Cookie.set("ORIGIN", 2, document.domain, "/", t), Me ? ne.replace(Me.buildSyncSearchUrl({
            _r: Math.random()
        })) : ne.href = "/"
            ...
            r = function() {
                t && (clearTimeout(t), t = !1), t = setTimeout(function() {
                    ...
                    r > o + i ? t = setTimeout(function() {
                        e.addClass("s_down"), Fe.done(function() {
                            Ee.hide()
                        })
...
function user_c(t) {
    ...
    return i = "&mu=" + r, s.src = a + "/v.gif?pid=201&pj=psuser&" + e + "path=" + r + "&wd=" + n + "&t=" + (new Date).getTime(), !0
}
...
function isbase64(t) {
    ...
    function n(t, e) {
        ...
        if (t = $.grep(t, function(t) {
            ...
            if (t.length > 12) {
                ...
                }), r(o, "right", "reqr2"), r(i, "right", "reqr1")
            } else r(t, "right", "reqr")
    }
    ...
    function i(t) {
        if ("string" == typeof t) {
            var e, n = 0,
                o = 0;
            for (e = 0; e < t.length; e++) o = e % 20 + 1, n += t.charCodeAt(e) << o;
            return Math.abs(n)
        }
        return 0
    }
    ...
    function r(t, e, n) {
        var r = l + "image?imglist=" + t.join(","),
            s = i(t.join(""));
        s = "cb_" + (s + "").substr(Math.max(0, s.length - 8), 8) + "_" + v.length, s = o(s), r += "&cb=" + s;
        var a = 1 * new Date,
            c = $.ajax({
                url: r,
                cache: !0,
                ...
                jsonpCallback: s,
                success: function(t) {
                    u[n] = 1 * new Date - a, "right" == e ? S(t) : "left" == e && I(t)
                }
            });
        c.always(function() {
    ...
    function s() {
        var t = v.concat(p.left, p.right),
            e = b = $.when.apply($, t);
        b.always(function() {
            +new Date, e === b && (2 == c.b64Exp && _("left"), _("right"))
        })
    }
    ...
    t.onSendlog(function() {
        ...
        u && $.each(u, function(t, n) {
            e.push(t + "_" + n)
        }), t.setParam("cus_cusval", e.join("|")), L.isinline() && (t.setParam("cus_b64il", L.ilsum), L.ilparseTime && t.setParam("cus_b64ilpt", L.ilparseTime), L.ilrenderTime && t.setParam("cus_b64ilrt", L.ilrenderTime))
    });
...
function extChangeUrl(t) {
    ...
    function createPlaceHolder(t, e, n) {
        if (e) t.attr("placeholder", n);
            ...
            var o = "<div class=kw-placeholder>" + n + "</div>";
            t.before(o), $(".kw-placeholder").on("click", function(e) {
        ...
        var json = {
            ...
            stringify: function() {
                var t = Object.prototype.toString,
                    ...
                    i = function(t) {
                        return o[t] || "\\u" + (t.charCodeAt(0) + 65536).toString(16).substr(1)
                    },
                    r = /[\\"\u0000-\u001F\u2028\u2029]/g;
                return function s(o) {
                    ...
                    if ("object" == typeof o) {
                        if ("function" == typeof o.toJSON) return s(o.toJSON());
                        if (n(o)) {
                            for (var a = "[", c = 0; c < o.length; c++) a += (c ? ", " : "") + s(o[c]);
                            return a + "]"
                        }
                        if ("[object Object]" === t.call(o)) {
                            var d = [];
                            for (var l in o) e.call(o, l) && d.push(s(l) + ": " + s(o[l]));
                            return "{" + d.join(", ") + "}"
                        }
                    }
...
! function(t) {
    ...
    function n(t, e) {
        ...
        var i = [];
        if ("string" == typeof t ? n(t) : A(t, function(t) {
                n(t)
            }), i.length > 0) throw new Error("[REQUIRE_FATAL]Relative ID is not allowed in global require: " + i.join(", "));
        var r = F.waitSeconds;
        return r && t instanceof Array && (U && clearTimeout(U), U = setTimeout(o, 1e3 * r)), H(t, e)
    }
    ...
    function o() {
        function t(s, a) {
            if (!r[s] && !m(s, M)) {
                r[s] = 1;
                var c = O[s];
                c ? (a || !m(s, P) || c.hang) && (o[s] || (o[s] = 1, e.push(s)), A(c.depMs, function(e) {
                    t(e.absId, e.hard)
                })) : i[s] || (i[s] = 1, n.push(s))
            }
        }
    ...
    function c(t) {
        ...
        if (e && !m(t, N)) {
            ...
            }), e.state = N, u(t), b(r), s.length && e.require(s, function() {
            ...
            if (!o && i.state === P) {
                ...
                if (A(i.factoryDeps, function(t) {
                    ...
                    try {
                        ...
                        null != s && (i.exports = s), i.invokeFactory = null
                    } catch (a) {
                        throw i.hang = 1, a
                    }
                    g(e)
    ...
    function f(t, e) {
        ...
        return A(t, function(t, o) {
            "object" == typeof t && (t = t.absId), n[o] = e[t] || O[t].exports
        }), n
    }

    function h(t, e) {
        if (m(t, M)) return void e();
        var n = G[t];
        n || (n = G[t] = []), n.push(e)
    }
    ...
    function b(e, n, o) {
        function i() {
            if ("function" == typeof n && !r) {
                var o = 1;
                A(e, function(t) {
                    return B[t] ? void 0 : o = !!m(t, M)
                }), o && (r = 1, n.apply(t, f(e, B)))
            }
        }
        var r = 0;
        A(e, function(t) {
            B[t] || m(t, M) || (h(t, i), (t.indexOf("!") > 0 ? w : v)(t, o))
        }), i()
    }
    ...
    function v(e) {
        ...
        function o() {
            if (s) {
                var n;
                "function" == typeof s.init && (n = s.init.apply(t, f(a, B))), null == n && s.exports && (n = t, A(s.exports.split("."), function(t) {
                    return n = n[t], !!n
                })), r(e, a, function() {
                    return n || {}
                })
    ...
    function y() {
        ...
        F.baseUrl = F.baseUrl.replace(/\/$/, "") + "/", V = _(F.paths), X = _(F.map, 1), A(X, function(t) {
            t.v = _(t.v)
        });
        var e = X[X.length - 1];
        e && "*" === e.k && A(X, function(t) {
            t != e && (t.v = t.v.concat(e.v))
        }), J = [], A(F.packages, function(t) {
            var e = t;
            "string" == typeof t && (e = {
                name: t.split("/")[0],
                location: t,
                main: "main"
            }), e.location = e.location || e.name, e.main = (e.main || "main").replace(/\.js$/i, ""), e.reg = R(e.name), J.push(e)
        }), J.sort(L), Y = _(F.urlArgs, 1), K = {};
        for (var n in F.bundles) A(F.bundles[n], t)
    }
    ...
    function $(t, e) {
        var n = /(\.[a-z0-9]+)$/i,
            ...
            r = t,
            s = "";
        o.test(t) && (s = RegExp.$1, t = t.replace(o, "")), n.test(t) && (i = RegExp.$1, r = t.replace(n, "")), null != e && (r = T(r, e));
        var a, c = r;
        return x(r, V, function(t, e) {
            c = c.replace(e, t), a = 1
        }), a || x(r, J, function(t, e, n) {
            c = c.replace(n.name, n.location)
        }), /^([a-z]{2,10}:\/)?\//i.test(c) || (c = F.baseUrl + c), c += i + s, x(r, Y, function(t) {
            c += (c.indexOf("?") > 0 ? "&" : "?") + t
        }), c
    }
    ...
    function k(t) {
        function n(n, i) {
            if ("string" == typeof n) {
                if (!o[n]) {
                    var r = T(n, t);
                    if (p(r), !m(r, M)) throw new Error('[MODULE_MISS]"' + r + '" is not exists!');
                    o[n] = O[r].exports
                }
                return o[n]
            }
    ...
    function T(t, e) {
        ...
        if (x(e, X, function(t) {
            ...
            var r = m(i, M) && H(i);
            o = r && r.normalize ? r.normalize(o, function(t) {
                return T(t, e)
            }) : T(o, e), i += "!" + o
        }
        return i
    ...
    function q(t, e) {
        ...
        o.setAttribute("data-require-id", t), o.src = $(t + ".js"), o.async = !0, o.readyState ? o.onreadystatechange = n : o.onload = n, Z = o, ne ? ee.insertBefore(o, ne) : ee.appendChild(o), Z = null
    }
    var U, O = {},
        E = 1,
        N = 2,
    ...
    n.version = "2.1.4", n.loader = "esl", n.toUrl = H.toUrl;
    var W = [];
    r.amd = {};
    var G = {},
        Q = {};
    ...
    ne && (ee = ne.parentNode), define || (define = r, require || (require = n), esl = n);
    var oe;
    ! function() {
        for (var t = document.getElementsByTagName("script"), e = t.length; e--;) {
            var n = t[e];
...
jQuery && jQuery.extend({
            ...
            function n(t) {
                ...
                for (n = 0; r > n; n++) switch (o = t[n], typeof o) {
                    ...
                    case "unknown":
                        break;
                    default:
                        e && i.push(","), i.push($.stringify(o)), e = 1
                }
                return i.push("]"), i.join("")
            }
            if ("JSON" in window) return JSON.stringify(t);
            var o = typeof t;
            if ("object" != o || null === t) return "string" == o && (t = '"' + t + '"'), String(t);
            var i = {
                "\b": "\\b",
                "	": "\\t",
                "\n": "\\n",
        ...
        format: function(t, e) {
            ...
            return n.length ? (n = 1 == n.length && null !== e && /\[object Array\]|\[object Object\]/.test(o.call(e)) ? e : n, t.replace(/#\{(.+?)\}/g, function(t, e) {
                var i = n[e];
                return "[object Function]" == o.call(i) && (i = i(e)), "undefined" == typeof i ? "" : i
            })) : t
        },
        subByte: function(t, e, n) {
            var o = [],
                i = t.split("");
            n = n || "…";
            for (var r = 0, s = i.length; s > r; r++) i[r].charCodeAt(0) > 255 && o.push("*"), o.push(i[r]);
            return e && e > 0 && o.length > e ? i = o.join("").substring(0, e - 1).replace(/\*/g, "") + n : t
        },
        getByteLength: function(t) {
            for (var e = [], n = t.split(""), o = 0, i = n.length; i > o; o++) n[o].charCodeAt(0) > 255 && e.push("*"), e.push(n[o]);
            return e.length
        },
        ...
        setCookie: function(t, e, n) {
            if (e = encodeURIComponent(e), jQuery._isValidKey(t)) {
                n = n || {};
                var o = n.expires;
                "number" == typeof n.expires && (o = new Date, o.setTime(o.getTime() + n.expires)), document.cookie = t + "=" + e + (n.path ? "; path=" + n.path : "") + (o ? "; expires=" + o.toGMTString() : "") + (n.domain ? "; domain=" + n.domain : "") + (n.secure ? "; secure" : "")
            }
        },
    ...
    function() {
        var t = window.bds.aladdin,
            ...
            d = function() {
                for (var t, e, n = $(".result-op").get().concat($(".result").get()), o = {}, i = 0; e = n[i]; i++)(t = e.getAttribute("tpl")) && (o[t] ? o[t].push(e) : o[t] = [e]);
                return o
            },
            l = [],
            u = [];
        t.addDisposeHandler = function(t) {
            ...
            _init: function() {
                ...
                e.p1 = n.p1 || t.id, e.mu = n.mu || t.getAttribute("mu"), e.srcid = n.rsv_srcid || t.getAttribute("srcid")
            },
            q: function(t, e) {
            ...
            $.each(t.mergeFns, function(e, o) {
                ...
                i && $.each(i, function(e, n) {
                    t._currentContainer = n, o.fn(), t._currentContainer = null
                })
            }), $.each(t.groupData, function(n, o) {
                var r, s, a, c = new t._Aladdin;
                c.container = o.container, c.data = o.data, c._init(), t.list.push(c);
                var d = o.handlers;
                ...
                "function" == typeof c.dispose && (l.push({
                    ...
                    srcid: c.srcid
                }, a.tpl = c.container.getAttribute("tpl"), a.time = s - r, t.loadTimes.push(a), $.each(e, function(t, e) {
                    e.call(c, c)
                })
            })
        }
    ...
    function() {
        function t(r, s) {
            ...
            if (a.length > 1)
                if (s) t(a.shift(), function() {
                    a.length > 0 && t(a, s)
                });
                else
                    for (; a.length;) t(a.shift());
            else {
                if (r = a[0], "jquery" === r && window.jQuery) return !i.ui.jquery && (i.ui.jquery = window.jQuery), void(s && s());
                var c = r.replace(/\./g, "/"),
                    d = r.replace(/^[\s\S]*\./, ""),
                    l = i.uiPrefix + c + "/" + d;
        ...
        function e(t, e) {
            ...
            n.rel = "stylesheet", n.type = "text/css", n.href = t, n.setAttribute("data-for", "A.ui"), d.appendChild(n), r[t] = 1, e()
        }
        ...
        function o(t, e) {
            ...
            o.type = "text/javascript", o.charset = "gb2312", o.onload = o.onreadystatechange = function() {
                if (!this.readyState || "loaded" === this.readyState || "complete" === this.readyState) {
                    ...
                    delete s[t], r[t] = 1, o.onload = o.onreadystatechange = null
                }
            }, o.src = t, o.setAttribute("data-for", "A.ui"), d.insertBefore(o, d.firstChild)
        }
        var i = window.A,
            r = {},
            s = {},
        ...
        }), t.cache = r, i.uicss = function(t) {
            e(i.uiPrefix + t)
        }, i.uijs = function(t, e) {
            o(i.uiPrefix + t, e)
        }, i.uijsPathMap = function(t) {
            $.extend(m, t)
        }, i.use = t, i.ui = i.ui || {}, i.addCssText = function(t) {
                    ...
                    $(t).each(function(t, o) {
                        ...
                        r.onload = function() {
                            var t = e,
                                ...
                                a = this.height,
                                c = s / a / (t / o);
                            c > 1 ? (s = s > t ? t : "auto", a = "auto") : (a = a > o ? o : "auto", s = "auto"), i.css({
                                height: a,
                                width: s
        ...
        function t(t, e) {
            if ("function" == typeof e || e instanceof Function) {
                var n = i(t);
                r[n.name] = r[n.name] || [], r[n.name].push({
                    prod: n.prod,
                    callback: e
                })
            }
        ...
        var r = {};
        this.on = t, this.off = e, this.trigger = n, this.events = r
        ...
        function getXPath(t, e, n) {
            ...
            if (t.parentNode !== e && (n = getXPath(t.parentNode, e, n)), t.previousSibling) {
                var o = 1,
                    i = t.previousSibling;
                do 1 == i.nodeType && i.nodeName == t.nodeName && o++, i = i.previousSibling; while (i)
            }
            return 1 == t.nodeType && n.push(t.nodeName.toLowerCase() + (o > 1 ? o : "")), n
        }
        ...
        function bindLogEvent() {
            $body = $("body"), $body.on("mousedown", function(t) {
                ...
                try {
                    ...
                    if (!r.length) return;
                    r.hasClass("result-op") ? o = "alop" : r.hasClass("result") && (o = "as"), i = r.get(0);
                    var s = getXPath(e, i);
        ...
        function log(t, e, n, o) {
            if (null == e.getAttribute("data-nolog")) {
                ...
                p = $.trim(p), d && "#" !== d.slice(-1) && /^http/.test(d) || (d = s);
                var g = {
                        rsv_xpath: t.join("-") + "(" + i + ")",
                        title: p,
                        url: d,
...
$(document).ready(function() {
        ...
        $(document).on("click", ".t>a,.op-se-listen-recommend", function(e) {
            ...
            !e.ctrlKey && (i.length && "none" === i.css("display") || r.length && "none" === r.css("display")) && (t = setTimeout(function() {
                n.find(".c-recommend").hide(), i.show(), n.find(".wnor-fanli-wrap").hide(), r.show()
            }, 150))
        }), $(window).on("swap_begin", function() {
            this.clearTimeout(t)
        })
...
! function() {
    ...
    if (window.fa = function(t) {
        ...
        if (r || h || s || a || c || d || l || u || m || p || f) {
            ...
            v && sethfPos && (t(v), i = "home"), v.setAttribute("onClick", "h(this)"), v.setAttribute("onmousedown", "return ns_c({'fm':'behs','tab':'homepage','pos':0})"), v.href = "/", v.target = "_self", v.id = "seth"
        }
    } catch (g) {} else {
        var b = document.getElementById(sethfPos ? "set_f" : "setf");
    ...
    var t = "",
        ...
        i = function(o) {
            e ? (bds.se.passv3.setSubpro(t), bds.se.passv3.setMakeText(n), bds.se.loginCallbackFunc = o || function() {
                ...
                initPassV3(), e = !0, bds.se.passv3.setSubpro(t), bds.se.passv3.setMakeText(n), bds.se.loginCallbackFunc = o || function() {
                    window.document.location.reload(!0)
                }, bds.se.passv3.show()
            })
        },
...
bds.se = bds.se || {}, bds.se.tool = bds.se.tool || {}, bds.comm.host = {
    ...
    if (this.op = t || {}, this.init = function(t, e) {
            if (t) {
                ...
                n.src = o + "?url=" + encodeURIComponent(t.url) + "&jump=" + encodeURIComponent(i + "/myfavorite/set?irt=1&t=" + encodeURIComponent(t.title) + "&id=" + encodeURIComponent(e) + "&c=bds.se.tool.favo.succ") + "&key=url", document.body.appendChild(n)
            }
...
bds.se = bds.se || {}, bds.se.slide = function(t) {
    ...
    this._default = {
    ...
    }, this.timer = [], this.otherTimer = [], this.op = $.extend({}, s._default, t), this.init = function() {
        ...
        var t = '<div style="position:absolute;top:0;left:50%;background:url(#{0}) no-repeat #{1};cursor:#{2};width:#{3}px;height:#{4}px;margin-left:-#{5}px;display:none;"></div>',
            ...
            h = s.op.width,
            g = s.op.height;
        d = f, i = h, r = g, t = $.format(t, s.op.src, l, p, s.op.width, s.op.height, s.op.width / 2), "static" === s.op.target.css("position") && s.op.target.css({
            position: "relative",
            width: "100%"
        }), s.op.target.append(t), e = o = s.op.target.find("div").eq(0), s.op.play && (n = $('<img src="' + s.op.play.src + '" style="width:' + s.op.play.width + "px; height:" + s.op.play.height + "px; position:absolute; top:50%; left:50%; margin-left: -" + s.op.play.width / 2 + "px; margin-top: -" + s.op.play.height / 2 + "px; \" onmousedown=\"return c({'tab':'logo_button_click'})\" />").insertAfter(e), o = n), s.op.isPad && e.css("background-size", s.op.width * s.op.frames / 2 + "px " + s.op.height + "px"), window.devicePixelRatio && window.devicePixelRatio > 1 && s.op.isRetina && e.css("background-size", s.op.width * s.op.frames + "px " + s.op.height + "px"), m.length ? (e.wrap('<a href="' + m.attr("href") + '" target="' + m.attr("target") + '"></a>'), m.attr("title") && e.attr("title", m.attr("title"))) : e.on("mousedown", function() {
            c({
        ...
        if (!(l >= d.length)) {
            ...
            }), u = new Image, u.src = s.op.src, e.bind("first_animate", function() {
                u.complete ? t() : u.onload = t
            }), i ? e.trigger("first_animate") : r && (s.enablePointer(), o.show().on(r, function() {
        ...
        var t = d[l],
            e = t.process_before;
        s.dispose(), e && e.call(s), s.animation()
        ...
        if (t = g ? d[l] : l + 1 >= d.length ? d[l] : d[l + 1]) {
            var v = t.trigger_type,
                ...
                y = t.trigger_frame;
            v && (f && o.off(f), l < d.length - 1 || g ? (s.enablePointer(), o.on(v, function() {
                g || l++, p && p.call(s), w && w.call(s), y && s.toPos(y), _ ? (s.dispose(), s.timer.push(setTimeout(function() {
                    s.play()
                }, _))) : s.play()
            })) : s.disablePointer())
        }! function() {
            arguments.callee, s.timer.push(setTimeout(function() {
                e.css("background-position", -(i * h) + "px 0"), h++, h >= c ? (s.dispose(), b++, 0 !== m && b >= m ? (h = null, b = null, p && p.call(s), l++, l < d.length && s.play(), g && l--) : (h = a - 1 > 0 ? a - 1 : 0, s.timer.push(setTimeout(arguments.callee, r)))) : s.timer.push(setTimeout(arguments.callee, r))
            }, u))
        }()
        ...
        s.dispose(), s.disposeOther(), o.off("click").off("hover")
        ...
        function t() {
            ...
            $(".unsafe_ico_new").each(function(e, i) {
                ...
                var r = $(i).attr("data-href"),
                    s = $(i).attr("href"),
                    a = r ? r : s;
                $("h3 a", $(i).parents(".result")).attr("href", a), t++
            }), t > 0 && ns_c({
                tab: "safetip",
                num_unsafe: t,
                prd: e.join("|"),
...
bds.se = bds.se || {}, bds.se.trust = bds.se.trust || {}, bds.se.trust = function() {
    function t() {
        d = [], l = [], $(".c-trust").each(function() {
            ...
            p = $.parseJSON($(this).attr("hint-data")), p && !$(this).attr("render") && (m = $(this), s(p, $(this).attr("hint-type")), $(this).attr("render", "render"))
    ...
    function n(t) {
        f = !1, 0 == t.code && $(l).each(function() {
            var e = this.getAttribute("data_key");
            p = t.data[e], p && (m = $(this), m.html(""), p.vstar && p.vstar.hint && p.vstar.hint.length > 0 && o(p.vstar.hint[0].vlevel, p.vstar.url), p.medical && i(), p.aviation && r())
        })
    }
    ...
    function o(t, e) {
        ...
        e && o.attr({
            href: e,
            onclick: ""
        }), m.append(n), m.append(o), s(p.vstar, "vstar")
    }
    ...
    function i() {
        ...
        m.append(t), m.append(e), s(p.medical, "medical")
    }
    ...
    function r() {
        ...
        m.append(t), m.append(e), s(p.aviation, "aviation")
    }
    ...
    if (l && (c = !0, a = l[1]), !(c && a >= 39)) {
        ...
        var u = function(t) {
            ...
            var r = $.getCookie("BAIDUID"),
                ...
                d = c + "pid=ps&fp=" + t.data.fp + "&im=" + t.data.im + "&wf=" + t.data.wf + "&br=" + t.data.br + "&qid=" + e + "&bi=" + r + "&psid=" + a;
            i.src = d
        };
...
bds.se = bds.se || {}, bds.se.upn = {
    ...
    t.prototype = {
        setCommLog: function(t, e, n) {
            ...
            if (!(t in this.commLog)) {
                var o = {};
                e && n ? (o.log = e, o.len = n) : (o.log = "&q=" + bds.comm.queryEnc + "&qid=" + bds.comm.qid + "&rsv_did=" + bds.comm.did + "&rsv_tn=" + bds.comm.tn + "&rsv_sid=" + bds.comm.sid, o.len = (o.log + "&t=" + (new Date).getTime()).length), this.commLog[t] = o
            }
            return !0
        },
        fb: function() {
        ...
        send: function(t, e, n) {
            ...
            var o = "",
                ...
                r = "";
            if ("object" == typeof t) {
                for (var s in t) o = t[s], "object" == typeof o && (o = $.stringify(o)), i += s + "=" + encodeURIComponent(o) + "&";
        ...
        fetchData: function(t, e) {
            function n() {
                for (var e, n = 0, o = [], r = !1, d = this.commLog[l].len, m = this.hostAddr[a].length, p = m + ("type=" + t + "&fm=" + u + "&data=").length + d, f = p + 6, h = f; 0 !== i.length && n < this.MAX_SEND;) c === !1 && 0 === t && n++, e = i.shift(), o.push(e), h = f + e.length + 3, (f >= this.MAX_LEN || h >= this.MAX_LEN) && (o.length >= 2 && (o.pop(), r = !0), s.push({
                    qid: l,
                    key: u,
                    type: t,
                    data: "%5B" + o.join("%2C") + "%5D",
                    host: a
                }), o = [], r && (o[0] = e, r = !1), h = o.length > 0 ? p + 3 + e.length + 3 : p + 6), f = h;
                o.length > 0 && s.push({
                    qid: l,
                    key: u,
                    type: t,
    ...
    dataType: "script",
    cache: !0,
    url: "https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/home/js/nu_instant_search_ff8ea96.js"
    ...
    var t, e = function(t, e) {
            ...
            if (r[2] && !o[r[2]]) {
                o.push(r[2]);
                var s = new Image;
                s.src = t + "?_t=" + (e ? e : n), s.onload = s.onerror = function() {
                    s = null
                }
            }
        },
    ...
    function writeBAIDUID() {
        ...
        /FG=(\d+)/.test(o) && (e = RegExp.$1), /SL=(\d+)/.test(o) && (n = RegExp.$1), /NR=(\d+)/.test(o) && (t = RegExp.$1), options.hasOwnProperty("resultNum") && (t = options.resultNum), options.hasOwnProperty("resultLang") && (n = options.resultLang), Cookie.set("BAIDUID", o.replace(/:.*$/, "") + ("undefined" != typeof n ? ":SL=" + n : "") + ("undefined" != typeof t ? ":NR=" + t : "") + ("undefined" != typeof e ? ":FG=" + e : ""), ".baidu.com", "/", expire30y, !0)
    }
...
bds.se = bds.se || {}, bds.se.speedTester = function() {
    ...
    function e() {
        var t = d.pop();
        t && n(t), a && (c = window.setTimeout(e, s))
    }
    ...
    function n(t) {
        var e = t.url,
            n = t.size || -1,
            o = [];
        o.push("id=" + encodeURIComponent(t.id)), o.push("name=" + encodeURIComponent(t.name)), o.push("url=" + encodeURIComponent(t.url)), o.push("size=" + encodeURIComponent(t.id));
        ...
        var t = function() {
            ...
            o = function() {
                ...
                var r = "//www.baidu.com/nocache/fesplg/s.gif?log_type=hm&type=timing&",
                    s = "";
                s += n.join("&"), s += "&newindex=" + (window.bds && bds.comm ? bds.comm.newindex : -1), e && (s += "&bsi=" + e);
                var a = r + s,
                    c = new Image,
...
$(document).delegate(".head_nums_cont_outer", "mousedown", function() {
            ...
            a += bds.comm.search_tool.st || bds.comm.search_tool.et ? " <li><a href='javascript:;' onClick='advChangeUrl(\"gpc\",\"stf\",this.innerHTML,0)'>时间不限</a></li>" : " <li><span>时间不限</span></li>", a += bds.comm.search_tool.st >= bds.comm.search_tool.thisDay && "1" == bds.comm.search_tool.stftype ? " <li><span>一天内</span></li>" : " <li><a href='javascript:;' onClick='advChangeUrl(\"gpc\",\"stf=" + bds.comm.search_tool.oneDay + "," + bds.comm.serverTime + "|stftype=1\",this.innerHTML,1)'>一天内</a></li>", a += bds.comm.search_tool.st >= bds.comm.search_tool.thisWeek && bds.comm.search_tool.st < bds.comm.search_tool.thisDay && "1" == bds.comm.search_tool.stftype ? " <li><span>一周内</span></li>" : " <li><a href='javascript:;' onClick='advChangeUrl(\"gpc\",\"stf=" + bds.comm.search_tool.oneWeek + "," + bds.comm.serverTime + "|stftype=1\",this.innerHTML,2)'>一周内</a></li>", a += bds.comm.search_tool.st >= bds.comm.search_tool.thisMonth && bds.comm.search_tool.st < bds.comm.search_tool.thisWeek && "1" == bds.comm.search_tool.stftype ? " <li><span>一月内</span></li>" : " <li><a href='javascript:;' onClick='advChangeUrl(\"gpc\",\"stf=" + bds.comm.search_tool.oneMonth + "," + bds.comm.serverTime + "|stftype=1\",this.innerHTML,3)'>一月内</a></li>", a += bds.comm.search_tool.st >= bds.comm.search_tool.thisYear && bds.comm.search_tool.st < bds.comm.search_tool.thisMonth && "1" == bds.comm.search_tool.stftype ? " <li><span>一年内</span></li>" : " <li><a href='javascript:;' onClick='advChangeUrl(\"gpc\",\"stf=" + bds.comm.search_tool.oneYear + "," + bds.comm.serverTime + "|stftype=1\",this.innerHTML,4)'>一年内</a></li>", a += " <li class='c-tip-custom'>", a += " <hr />自定义", a += " <p class='c-tip-custom-st'>从<input name='st' date-min='0' date-max='" + formatDate(1e3 * bds.comm.serverTime) + "' type='txt' autocomplete='off' ", a += bds.comm.search_tool.st && bds.comm.search_tool.et && "2" == bds.comm.search_tool.stftype ? "value='" + formatDate(1e3 * bds.comm.search_tool.st, "-") + "' data-value='" + 1e3 * bds.comm.search_tool.st + "' class='c-tip-custom-input'/></p>" : "value='" + formatDate(1e3 * bds.comm.serverTime, "-") + "' data-value='' class='c-tip-custom-input c-tip-custom-input-init'/></p>", a += "  <p class='c-tip-custom-et'>至<input name='et' date-min='0' date-max='" + formatDate(1e3 * bds.comm.serverTime) + "' type='txt' autocomplete='off' ", a += bds.comm.search_tool.st && bds.comm.search_tool.et && "2" == bds.comm.search_tool.stftype ? "value='" + formatDate(1e3 * bds.comm.search_tool.et, "-") + "' data-value='" + 1e3 * bds.comm.search_tool.et + "' class='c-tip-custom-input'/></p>" : "value='" + formatDate(1e3 * bds.comm.serverTime, "-") + "' data-value='' class='c-tip-custom-input c-tip-custom-input-init'/></p>", a += "<div class='c-tip-timerfilter-custom-error'>自定义时间错误！</div>", a += "<a href='javascript:;' class='c-tip-custom-submit'>确认</a>", a += "</li></ul></div>", timefilterTip = new bds.se.tip({
                ...
                onShow: function() {
                    $(this.getTarget()).width() > 95 && $("ul", this.getDom()).width($(this.getTarget()).width() + 20), $(".c-tip-custom-input").on("click", function(t) {
                        ...
                        $(e).attr("data-value") && o.setTime($(e).attr("data-value")), $(e).parents(".c-tip-custom").find(".c-tip-custom-input").removeClass("c-tip-custom-input-focus"), $(e).addClass("c-tip-custom-input-focus"), 0 == $("#c-tip-custom-calenderCont").length && $(e).parents(".c-tip-custom").append("<div id='c-tip-custom-calenderCont'></div>"), $("#c-tip-custom-calenderCont").html("");
                        var a = {
                        ...
                        function t(t) {
                            var e, n = /^\s*(\d{4})-(\d\d)-(\d\d)\s*$/,
                                o = new Date(0 / 0),
                                i = n.exec(t);
                            return i && (e = +i[2], o.setFullYear(i[1], e - 1, i[3]), e != o.getMonth() + 1 && o.setTime(0 / 0)), o
                        }
                        var e = this,
                            n = t($(e).val());
                    ...
                    try {
                        $(".c-tip-custom-submit").off("click.searchTool").on("click.searchTool", function(t) {
                            ...
                            return $("#c-tip-custom-calenderCont").hide(), "" != o && o || (o = 0), "" != i && i || !o || "" == o || (i = parseInt((new Date).setHours(23, 59, 58) / 1e3)), i > bds.comm.serverTime && (0 >= o ? (o = "", i = "") : i = parseInt((new Date).setHours(23, 59, 58) / 1e3)), o > i || o > bds.comm.serverTime ? ($(".c-tip-timerfilter-custom-error").show(), void t.stopPropagation()) : (0 == o && 0 == i && (o = "", i = ""), $(".c-tip-timerfilter-custom-error").hide(), void advChangeUrl("gpc", "stf=" + o + "," + i + "|stftype=2", "自定义时间:" + o + "|" + i, 5))
                        })
                    } catch (t) {}
                }
            }), timefilterTip.hide()
                ...
                try {
                    $(".c-tip-timerfilter-si-submit").off("click.searchTool").on("click.searchTool", function(t) {
                        ...
                        if ("" == o) ns_c({
                            ...
                            if (!o.match(/^[\w\-_]+(\.[\w\-_]+)+$/)) return $(".c-tip-timerfilter-si-error").show(), t.stopPropagation(), t.preventDefault(), !1;
    ...
    function t() {
        ...
        var e = {},
            n = {},
            o = $("#wrapper");
        return e.topResult = o.find("#con-at").find(".result-op"), e.rightResult = o.find("#con-ar").find(".result-op"), e.leftResult = o.find("#content_left").find(".result, .result-op"), e.topResult.length && (n.T = [], e.topResult.each(function() {
            n.T.push(t("T", $(this)))
    ...
    $(window).on("swap_end", function() {
        var t = function() {
            ...
            return n ? ($.each(n, function(e, n) {
                var o = {};
                o.dom = n.dom, o.id = n.id, o.itime = 0, o.time = 0, t.push(o)
            }), t) : null
        };
    ...
    bds.se.display = function() {
                    ...
                    for (var i in t.expand[o])
                        if (i && t.expand[o][i] && t.expand[o][i].length)
                            for (var r = t.expand[o][i], s = 0; s < r.length; s++) {
                                ...
                                a[o] = {
                                    expand: {}
                                }, a[o].expand[i] = {}, a[o].expand[i][s] = r[s], bds.log.send.sendPack("new_disp", a)
                            }
        },
        getBase: function() {
            var t = this,
        ...
        getResult: function(t) {
            for (var e = this, n = t, o = 0, i = Math.min(n.length, 10); i > o; o++) {
                ...
                e.expand[r] = s.expand, delete s.expand, e.display[r] = s
            }
        },
        getResultDisplay: function(t) {
            ...
            l.size = e(), l.pos = n(), o() && (l.bdr = o()), l.com = i();
            var u = r(),
                m = s(),
                p = a();
    ...
    t.prototype = {
        ...
        getDom: function(t) {
            ...
            return $.each(t, function(t, n) {
                var o = {};
                o.top = n.pos.top, o.height = n.size.height, o.id = n.id, o.visible = 0, e.push(o)
            }), e
        },
        ...
        bindEvent: function(t) {
            ...
            $.each(t, function(t, n) {
                ...
                n.dom.bind("mouseenter.useraction", function() {
                    ...
                    null !== r && (clearTimeout(r), r = null), i && (e.sendLog("new_view", {
                        type: "mouseOut",
                        id: n.id,
                        t: (new Date).getTime()
                    }), i = !1)
        ...
        collectPoint: function(t) {
            function e() {
                r[o] = setTimeout(function() {
                    r.sendLog("new_view", n(t)), r[i] = !1, r.sight(), r[i] ? e() : r[o] = null
                }, 1e3)
            }
            ...
            function n(t) {
                if ("resize" === t) {
                    var e = $(window);
                    return r.windowHeight = e.height(), r.windowWidth = e.width(), {
                        type: "resize",
                        t: (new Date).getTime(),
                ...
                if ("scroll" === t) {
                    var n = $(document);
                    return r.scrollTop = n.scrollTop(), r.scrollLeft = n.scrollLeft(), {
                        type: "scroll",
                        t: (new Date).getTime(),
                        offsetX: r.scrollTop,
    ...
    log: function(t) {
        ...
        return e.rsv_re_fcurl = m.length ? m.attr("href") : r, e.rsv_re_fcurl = e.rsv_re_fcurl || "", e.rsv_re_fcurl = encodeURIComponent(e.rsv_re_fcurl), c($.extend(e, t))
    },
    getLeftP: function() {
    ...
    buildRcmdDom: function(t) {
        for (var e = this, n = "", o = t.linkInfo, i = t.linkInfo2, r = 0, s = o.length; s > r; r++) {
            var a = o[r].txt,
                c = o[r].wd,
                d = o[r].sa,
                l = "c-gap-left-large";
            0 == r && (l = "");
            var u = "wd=" + c + "&rsv_crq=" + d + "&bs=" + bds.comm.query,
                m = e.buildURL(u);
            n += "<a class='" + l + "' href='" + m + "' title='" + a + "' target='_blank'>" + a + "</a>"
        }
        if (i) {
            n += "<a style='height:0;display:inline-block;'></a>";
            for (var r = 0, s = i.length; s > r; r++) {
                var a = i[r].txt,
                    ...
                    l = "c-gap-left-large",
                    p = "";
                0 == r && (p = "margin-left:88px;");
                var u = "wd=" + c + "&rsv_crq=" + d + "&bs=" + bds.comm.query,
                    m = e.buildURL(u);
                n += "<a class='" + l + "' href='" + m + "' title='" + a + "' target='_blank' style='" + p + "'>" + a + "</a>"
            }
        }
        return n
    },
        ...
        if (t && e) {
            ...
            return o.right_recommends_merge = function(t) {
                function o(e, o) {
                    ...
                    e.list && !e.list.length && (e.list = [e.list]), d += $.format(r, e.subtitle, e.subtitle, $.stringify(u)), d += '<div class="rrecom-panel">';
                    for (var m = n.op.target.find(".t>a").eq(0), p = m.length ? m.attr("href") : n.op.target.attr("mu"), f = 0, h = e.list.length; h > f; f++) {
                        ...
                        if (f == l) break;
                        f % 4 === 0 && (d += s), bds.util && bds.util.domain && bds.util.domain.get && (i.img = bds.util.domain.get(i.img)), d += $.format(a, b, i.img, i.name, b, $.subByte(i.name, 20), (f + 1) % 4 === 0 ? " c-span-last rrecom-item-rowLast" : (f + 1) % 4 === 3 ? " rrecom-item-s" : "", $.stringify(g), i.attrpic), d += c, ((f + 1) % 4 === 0 || f == h - 1) && (d += c)
                    }
                    return d += c, d += c
                }
                var t = t || e,
    ...
    render: function(t) {
        ...
        var o = this.getLeftP();
        o.fm = "alxr", this.recommDom.attr("data-click", $.stringify(o)).find(".rrecom-content").eq(0).empty().append(e), this.setRecommPosition()
    },
    ...
    setRecommSize: function() {
        ...
        this.recommDom.height(s.h), bds.comm.recommends.recommWidth = r.w - i.left - 2, this.recommDom.css({
            width: r.w - i.left - 2,
    ...
    bindRecommEvent: function() {
        ...
        this.recommDom.find(".rrecom-btn-close").eq(0).on("click", function() {
            ...
            if (t.recommDom && "none" !== t.recommDom.css("display")) {
                e = s.scrollTop(), n = s.scrollLeft(), r -= e, e <= i.top - r ? "fixed" === t.recommDom.css("position") && (t.recommDom.css("position", "absolute"), t.recommDom.css("top", i.top)) : "absolute" === t.recommDom.css("position") && (t.recommDom.css("position", "fixed"), t.recommDom.css("top", r));
    ...
    function e() {
        d = 1e3 * (new Date).getTime() + Math.round(1e3 * Math.random()) - 149e13, c >= .005 && .0051 > c && (o(), i(), r(), s())
    }
    ...
    function n() {
        var t = Math.round(1e3 * Math.random()) % u.length,
            ...
            o = u[t];
        e.onload = function() {
            n.src = "//www.baidu.com/nocache/fesplg/s.gif?lid=" + d + "&url=" + encodeURIComponent(o) + "&time=" + ((new Date).getTime() - i) + "&suc=1&type=aboard&dev=pc&protocol=" + encodeURIComponent(location.protocol) + "&ran=" + (new Date).getTime()
        }, e.onerror = function() {
            n.src = "//www.baidu.com/nocache/fesplg/s.gif?lid=" + d + "&url=" + encodeURIComponent(o) + "&time=&suc=0&type=aboard&dev=pc&protocol=" + encodeURIComponent(location.protocol) + "&ran=" + (new Date).getTime()
        };
            ...
            if (!t || !$(o.target).closest(t.getDom()).length) try {
                setTimeout(function() {
                    if (window.getSelection) {
                        ...
                        r = i.getRangeAt(0), s = r.getBoundingClientRect(), a = $.trim(i.toString()), c = $("#text" == r.commonAncestorContainer.nodeName ? r.commonAncestorContainer.parentNode : r.commonAncestorContainer)
                        ...
                        e = $.ajax({
                            ...
                            success: function(e) {
                                ...
                                if (e && e.data && e.data.type && e.data.to && "zh" == e.data.to && e.data.result && e.data.result.length && e.data.result != a)
                                    if (1 == e.data.type)
                                        for (var o = e.data.result, i = 0, r = Math.min(o.length, 2); r > i; i++) n += (0 == i ? "" : "<br/>") + (o[i].pre ? o[i].pre + "&nbsp;" : ""), n += o[i].cont ? $.subByte(o[i].cont, 46 * (1 == r ? 2 : 1) + 1) : "";
    ...
    function t(t) {
        return t = i(t), t.attr("id") || t.attr("data-click") && $.parseJSON(t.attr("data-click")).rsv_srcid || t.attr("class") || "-1"
    }

    function e(t) {
        var e = i(t),
            n = e.clone();
        n.unbind(), n.children(".fb-list-container").remove(), n.children(".fb-list-container-first").remove(), n.children(".fb-hint-tip").remove(), n.removeAttr("style"), n.css("margin", "0"), t.append(n), t.append("<div class='fb-mask-light' data-html2canvas-ignore='true'></div>"), t.addClass("fb-list-container-hover")
    }
    ...
    function a(t, e) {
        this.init = function() {
            ...
            c.id = "fb_baidu_right_dialog", c.className = "fb-feedback-right-dialog", c.className = "fb-feedback-right-dialog", c.setAttribute("data-html2canvas-ignore", "true"), c.innerHTML = t, this.dom = c
        }, this.bindEvent = function() {
            var t = this;
            ...
            this.content = $(this.dom).find(".fb-des-content").val(), this.type = $(this.dom).find(".fb-select-value").val(), this.email = $(this.dom).find(".fb-email").val(), data = {
                product_type: 26138,
                ...
                alert("fail")
            }), $(this.dom).find(".fb-modal ").remove(), $(this.dom).find(".fb-mask").remove(), $(this.dom).find(".fb-success").css("display", "block"), setTimeout(function() {
                o()
            }, 1e3)
        }, this.init()
    }
    ...
    function c(t, e) {
        this.init = function() {
            ...
            o.id = "fb_baidu_list_dialog", o.className = "fb-feedback-list-dialog", o.setAttribute("data-html2canvas-ignore", "true"), o.innerHTML = t, this.dom = o, $(this.dom).css("top", this.top), $(this.dom).css("left", this.left), "con-ar" == this.order && $(this.dom).attr("class", "fb-feedback-list-dialog-left")
        }, this.bindEvent = function() {
            var t = this;
            $(this.dom).find(".fb-close").on("click", function() {
                t.destory(), n($(".fb-list-container")), bds.se.ShortCut.key = 0, bds.se.ShortCut.rdialog && bds.se.ShortCut.rdialog.grayed(0), bds.se.ShortCut.rdialog || o()
            ...
            var t = this;
            this.content = $(this.dom).find(".fb-des-content").val(), this.type = $(this.dom).find(".fb-select-value").val(), this.email = $(this.dom).find(".fb-email").val(), bds.se.ShortCut.get_Snapshot_list(-bds.se.ShortCut.curListDom.offset().left, -bds.se.ShortCut.curListDom.offset().top, bds.se.ShortCut.curListDom.width() + 20, bds.se.ShortCut.curListDom.height() + 12, function() {
                data = {
                    product_type: 26138,
                    content: t.content,
                    type: t.type,
    ...
    bds && bds.se && (bds.se.ShortCut = {
        ...
        init_ala: function(t) {
            this.html2canvas(), bds.se.ShortCut.uploadImg = this._identifyCanvas() && this._identifyCors() ? !0 : !1, $("#container").append("<div class='fb-mask' data-html2canvas-ignore='true'></div>"), t.append("<div class='fb-list-container' data-html2canvas-ignore='true'></div>"), t.find(".fb-list-container").css("width", t.width() + 20), t.find(".fb-list-container").css("height", t.height() + 10), e(t.find(".fb-list-container")), bds.se.ShortCut.ldialog = new c(t, 1), bds.se.ShortCut.curListDom = t.find(".fb-list-container"), $(".fb-mask").on("click", function() {
                o(), bds.se.ShortCut.ldialog && bds.se.ShortCut.ldialog.destory()
            })
        },
        init_shade: function() {
            $("#container").append("<div class='fb-mask' data-html2canvas-ignore='true'></div>"), r(), $(".fb-list-container").hover(function(t) {
                i($(t.currentTarget)), $(t.currentTarget).children().length || e($(t.currentTarget))
            }, function(e) {
        ...
        get_Snapshot: function() {
            $(window).scrollTop(0);
            var t = this;
            bds.se.ShortCut.rdialog = new a, t.init_shade(), $(".fb-canvas-block").addClass("c-loading"), html2canvas(document.body, {
                ...
                onrendered: function(e) {
                    ...
                    o.drawImage(e, 0, 0), bds.se.ShortCut.img_base64 = n.toDataURL("image/png"), $(".fb-canvas-block img").attr("src", n.toDataURL("image/png")), setTimeout(function() {
                        t.canvas_block_height = $(".fb-canvas-block img").height()
                    }, 50), $(document).on("scroll.feedback", function() {
                        var e = $(window).scrollTop(),
                            n = $(document).height(),
                            o = $(window).height();
                        scrollPercent = e / (n - o), $(".fb-canvas-block img").css("top", -(t.canvas_block_height - 172) * scrollPercent)
                    })
                }
            })
        },
        get_Snapshot_list: function(t, e, n, o, i) {
            html2canvas(document.body, {
                ...
                onrendered: function(r) {
                    ...
                    a.drawImage(r, t, e), bds.se.ShortCut.img_base64_list = s.toDataURL("image/png"), i()
                }
            })
        },
        html2canvas: function() {
            ! function(t, e, n) {
                ...
                function i(t, e, n, o, i, r) {
                    ...
                    if (1 === u.length && (l = u[0], u = [], u[0] = l, u[1] = l), -1 !== u[0].toString().indexOf("%")) c = parseFloat(u[0]) / 100, a = n.width * c, "backgroundSize" !== t && (a -= (r || o).width * c);
                ...
                d.Util = {}, d.Util.trimText = function(t) {
                        ...
                        function r(e, n) {
                            var o, i = t.runtimeStyle && t.runtimeStyle[e],
                                r = t.style;
                            return !/^-?[0-9]+\.?[0-9]*(?:px)?$/i.test(n) && /^-?\d/.test(n) && (o = r.left, i && (t.runtimeStyle.left = t.currentStyle.left), r.left = "fontSize" === e ? "1em" : n || 0, n = r.pixelLeft + "px", r.left = o, i && (t.runtimeStyle.left = i)), /^(thin|medium|thick)$/i.test(n) ? n : Math.round(parseFloat(n)) + "px"
                        }
                        ...
                        if (a !== t && (c = e.defaultView.getComputedStyle(t, null)), s = c[o], l) {
                            if (s = (s || "").split(","), s = s[i || 0] || s[0] || "auto", s = d.Util.trimText(s).split(" "), "backgroundSize" !== o || s[0] && !s[0].match(/cover|contain|auto/)) {
                                if (s[0] = -1 === s[0].indexOf("%") ? r(o + "X", s[0]) : s[0], s[1] === n) {
                                    if ("backgroundSize" === o) return s[1] = "auto", s;
                                    s[1] = s[0]
                                }
                        ...
                        try {
                            ...
                            o("html2canvas.Util.Children failed with exception: " + i.message), e = []
                        }
                        return e
                    ...
                    function() {
                            ...
                            if (r) switch (r[1]) {
                                ...
                                case "-o-linear-gradient":
                                    if (o = {
                                        ...
                                        for (c = a.length, i = 0; c > i; i += 1) switch (a[i]) {
                                            case "top":
                                                o.y0 = 0, o.y1 = n.height;
                                                break;
                                            case "right":
                                                o.x0 = n.width, o.x1 = 0;
                                                break;
                                            case "bottom":
                                                o.y0 = n.height, o.y1 = 0;
                                                break;
                                            case "left":
                                                o.x0 = 0, o.x1 = n.width
                                        }
                                    if (null === o.x0 && null === o.x1 && (o.x0 = o.x1 = n.width / 2), null === o.y0 && null === o.y1 && (o.y0 = o.y1 = n.height / 2), a = r[3].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\)(?:\s\d{1,3}(?:%|px))?)+/g))
                                        for (c = a.length, d = 1 / Math.max(c - 1, 1), i = 0; c > i; i += 1) l = a[i].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\s*(\d{1,3})?(%|px)?/), l[2] ? (s = parseFloat(l[2]), s /= "%" === l[3] ? 100 : n.width) : s = i * d, o.colorStops.push({
                                            color: l[1],
                                            stop: s
                                        });
                                    break;
                                case "-webkit-gradient":
                                    if (o = {
                                        ...
                                        for (c = a.length, i = 0; c > i; i += 1) l = a[i].match(/(from|to|color-stop)\(([0-9\.]+)?(?:,\s)?((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\)/), s = parseFloat(l[2]), "from" === l[1] && (s = 0), "to" === l[1] && (s = 1), o.colorStops.push({
                                            color: l[3],
                                            stop: s
                                        });
                                    break;
                                case "-moz-linear-gradient":
                                    if (o = {
                                        ...
                                        for (c = a.length, d = 1 / Math.max(c - 1, 1), i = 0; c > i; i += 1) l = a[i].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\s*(\d{1,3})?(%)?/), l[2] ? (s = parseFloat(l[2]), l[3] && (s /= 100)) : s = i * d, o.colorStops.push({
                                            color: l[1],
                                            stop: s
                                        });
                                    break;
                                ...
                                case "-o-radial-gradient":
                                    if (o = {
                                        ...
                                        case "cover":
                                        case "":
                                            u = Math.sqrt(Math.pow(o.cx, 2) + Math.pow(o.cy, 2)), m = Math.sqrt(Math.pow(o.cx, 2) + Math.pow(o.y1 - o.cy, 2)), p = Math.sqrt(Math.pow(o.x1 - o.cx, 2) + Math.pow(o.y1 - o.cy, 2)), f = Math.sqrt(Math.pow(o.x1 - o.cx, 2) + Math.pow(o.cy, 2)), o.rx = o.ry = Math.max(u, m, p, f);
                                            break;
                                        case "closest-corner":
                                            u = Math.sqrt(Math.pow(o.cx, 2) + Math.pow(o.cy, 2)), m = Math.sqrt(Math.pow(o.cx, 2) + Math.pow(o.y1 - o.cy, 2)), p = Math.sqrt(Math.pow(o.x1 - o.cx, 2) + Math.pow(o.y1 - o.cy, 2)), f = Math.sqrt(Math.pow(o.x1 - o.cx, 2) + Math.pow(o.cy, 2)), o.rx = o.ry = Math.min(u, m, p, f);
                                            break;
                                        case "farthest-side":
                            ...
                            if (0 !== n.width && 0 !== n.height) {
                                ...
                                if (c.width = n.width, c.height = n.height, i = d.Generate.parseGradient(t, n))
                                    if ("linear" === i.type) {
                                        ...
                                        l.fillStyle = r, l.fillRect(0, 0, n.width, n.height)
                                    ...
                                    p.fillStyle = r, p.fillRect(0, 0, h, h), l.fillStyle = i.colorStops[s - 1].color, l.fillRect(0, 0, c.width, c.height), l.drawImage(m, i.cx - i.rx, i.cy - i.ry, 2 * i.rx, 2 * i.ry)
                                }
                                return c
                            }
                        ...
                        function g(t, e, n, o) {
                            ...
                            return t.setVariable("fillStyle", o), t.setVariable("font", [ue(e, "fontStyle"), ue(e, "fontVariant"), r, a, s].join(" ")), t.setVariable("textAlign", i ? "right" : "left"), "none" !== n ? d.Util.Font(s, a, ae) : void 0
                        }
                        ...
                        function v(t, e, n, o) {
                            var i;
                            if (ce.rangeBounds)("none" !== n || 0 !== d.Util.trimText(e).length) && (i = w(e, t.node, t.textOffset)), t.textOffset += e.length;
                        ...
                        function w(t, e, n) {
                            ...
                            return o.setStart(e, n), o.setEnd(e, n + t.length), o.getBoundingClientRect()
                        }
                        ...
                        function x(t, e) {
                            ...
                            return i.style.display = "inline", n = t.style.listStyleType, t.style.listStyleType = "none", i.appendChild(ae.createTextNode(e)), t.insertBefore(i, t.firstChild), o = d.Util.Bounds(i), t.removeChild(i), t.style.listStyleType = n, o
                        }
                        ...
                        function T(t, e, n) {
                            ...
                            if (/^(decimal|decimal-leading-zero|upper-alpha|upper-latin|upper-roman|lower-alpha|lower-greek|lower-latin|lower-roman)$/i.test(a)) {
                                if (i = k(t, a), r = x(t, i), g(s, t, "none", ue(t, "color")), "inside" !== ue(t, "listStylePosition")) return;
                                s.setVariable("textAlign", "left"), o = n.left, h(i, o, r.bottom, s)
                            }
                        }
                        ...
                        function O(t, e, n, o, i) {
                            ...
                            switch (r) {
                                case "content-box":
                                case "padding-box":
                                    j(s, o[0], o[1], e.topLeftInner, e.topRightInner, i.left + n[3].width, i.top + n[0].width), j(s, o[1], o[2], e.topRightInner, e.bottomRightInner, i.left + i.width - n[1].width, i.top + n[0].width), j(s, o[2], o[3], e.bottomRightInner, e.bottomLeftInner, i.left + i.width - n[1].width, i.top + i.height - n[2].width), j(s, o[3], o[0], e.bottomLeftInner, e.topLeftInner, i.left + n[3].width, i.top + i.height - n[2].width);
                                    break;
                                default:
                                    j(s, o[0], o[1], e.topLeftOuter, e.topRightOuter, i.left, i.top), j(s, o[1], o[2], e.topRightOuter, e.bottomRightOuter, i.left + i.width, i.top), j(s, o[2], o[3], e.bottomRightOuter, e.bottomLeftOuter, i.left + i.width, i.top + i.height), j(s, o[3], o[0], e.bottomLeftOuter, e.topLeftOuter, i.left, i.top + i.height)
                            }
                            return s
                        }
                                ...
                                if (n[o].width > 0) {
                                    switch (i = d, r = l, s = u, a = m - n[2].width, o) {
                                        case 0:
                                            ...
                                            break;
                                        case 1:
                                            i = d + u - n[1].width, s = n[1].width, c = q({
                                                c1: [i + s, r],
                                            ...
                                            break;
                                        case 2:
                                            r = r + m - n[2].width, a = n[2].width, c = q({
                                                c1: [i + s, r + a],
                                                c2: [i, r + a],
                                                c3: [i + n[3].width, r],
                                                c4: [i + s - n[2].width, r]
                        ...
                        function z(t) {
                            t.drawImage.apply(t, Array.prototype.slice.call(arguments, 1)), se += 1
                        }
                        ...
                        function B(n, i) {
                            ...
                            if (r && r.content && "none" !== r.content && "-moz-alt-content" !== r.content) {
                                ...
                                return l.className = me + "-before " + me + "-after", Object.keys(r).filter(H).forEach(function(t) {
                                    try {
                                        l.style[t] = r[t]
                                    } catch (e) {
                        ...
                        function W(t, e, n, o) {
                            ...
                            t.createPattern(e), t.translate(i, r), t.fill(), t.translate(-i, -r)
                        }

                        function G(t, e, n, o, i, r, s, a) {
                            var c = [];
                            c.push(["line", Math.round(i), Math.round(r)]), c.push(["line", Math.round(i + s), Math.round(r)]), c.push(["line", Math.round(i + s), Math.round(a + r)]), c.push(["line", Math.round(i), Math.round(a + r)]), N(t, c), t.save(), t.clip(), W(t, e, n, o), t.restore()
                        }
                        ...
                        function J(t, e, n) {
                            for (var i, r = ue(t, "backgroundImage"), s = d.Util.parseBackgroundImage(r), a = s.length; a--;)
                                if (r = s[a], r.args && 0 !== r.args.length) {
                                    ...
                                    i = C(c), i ? V(t, e, n, i, a) : o("html2canvas: Error loading background:", r)
                                }
                        }
                        ...
                        function X(t, e) {
                            ...
                            return o.width = e.width, o.height = e.height, n = o.getContext("2d"), z(n, t, 0, 0, t.width, t.height, 0, 0, e.width, e.height), o
                        }

                        function K(t, e, n) {
                            var o = ue(e, "opacity") * (n ? n.opacity : 1);
                            return t.setVariable("globalAlpha", o), o
                        }
                        ...
                        function Y(t, e, n) {
                            ...
                            return a.useOverflow === !0 && /(hidden|scroll|auto)/.test(ue(t, "overflow")) === !0 && /(BODY)/i.test(t.nodeName) === !1 && (i.clip = i.clip ? S(i.clip, n) : n), i.zIndex.children.push(i), i
                        }
                        ...
                        function te(t, e, n) {
                            var i, r = d.Util.Bounds(t),
                                ...
                                u = Z(c, r, a.clip),
                                m = E(t, r, c);
                            switch (N(l, m.clip), l.save(), l.clip(), u.height > 0 && u.width > 0 && (Q(l, r, s), J(t, u, l)), l.restore(), m.borders.forEach(function(t) {
                                P(l, t.args, t.color)
                            }), n || F(t, a), t.nodeName) {
                                case "IMG":
                                    ...
                                    break;
                                case "INPUT":
                                    /^(text|url|email|submit|button|reset)$/.test(t.type) && (t.value || t.placeholder).length > 0 && M(t, r, a);
                                    break;
                                case "TEXTAREA":
                                    (t.value || t.placeholder || "").length > 0 && M(t, r, a);
                                    break;
                                case "SELECT":
                                    (t.options || t.placeholder || "").length > 0 && M(t, r, a);
                                    break;
                                case "LI":
                                    T(t, a, u);
                                    break;
                        ...
                        function oe(t, e) {
                            function n(t) {
                                ...
                                for (a = 0; l > a; a += 1)
                                    ...
                                    s += ">", n(r), s += "</" + r.nodeName.toLowerCase() + ">"
                                }
                            }
                            var o = new Image,
                                i = c(),
                                r = l(),
                                s = "";
                            n(t), o.src = ["data:image/svg+xml,", "<svg xmlns='http://www.w3.org/2000/svg' version='1.1' width='" + i + "' height='" + r + "'>", "<foreignObject width='" + i + "' height='" + r + "'>", "<html xmlns='http://www.w3.org/1999/xhtml' style='margin:0;'>", s.replace(/\#/g, "%23"), "</html>", "</foreignObject>", "</svg>"].join(""), o.onload = function() {
                                e.svgRender = o
                            }
                        }
                        ...
                        function ie() {
                            var t = te(re, null);
                            return ce.svgRendering && oe(e.documentElement, t), Array.prototype.slice.call(re.children, 0).forEach(function(e) {
                                ne(e, t)
                        ...
                        pe.innerHTML = "." + me + '-before:before { content: "" !important; display: none !important; }.' + me + '-after:after { content: "" !important; display: none !important; }', le.appendChild(pe), i = i || {};
                        var fe = function(t) {
                        ...
                        function a(e, o, r) {
                            var a, c, d = i.proxy;
                            C.href = e, e = C.href, a = "html2canvas_" + y++, r.callbackname = a, d += d.indexOf("?") > -1 ? "&" : "?", d += "url=" + encodeURIComponent(e) + "&callback=" + a, c = $.createElement("script"), t[a] = function(e) {
                                "error:" === e.substring(0, 6) ? (r.succeeded = !1, _.numLoaded++, _.numFailed++, s()) : (h(o, r), o.src = e), t[a] = n;
                                try {
                                    delete t[a]
                                } catch (i) {}
                                c.parentNode.removeChild(c), c = null, delete r.script, delete r.callbackname
                            }, c.setAttribute("type", "text/javascript"), c.setAttribute("src", d), r.script = c, t.document.body.appendChild(c)
                        }

                        function c(e, n) {
                            var o = t.getComputedStyle(e, n),
                                i = o.content;
                            "url" === i.substr(0, 3) && b.loadImage(d.Util.parseBackgroundImage(i)[0].args[0]), p(o.backgroundImage, e)
                        }
                        ...
                        function f(t) {
                            ...
                            try {
                                ...
                                e = !1, o("html2canvas: failed to access some element's nodeType - Exception: " + r.message)
                            }
                            if (1 === e || e === n) {
                                l(t);
                                try {
                        ...
                        function h(e, o) {
                            e.onload = function() {
                                o.timer !== n && t.clearTimeout(o.timer), _.numLoaded++, o.succeeded = !0, e.onerror = e.onload = null, s()
                            }, e.onerror = function() {
                                if ("anonymous" === e.crossOrigin && (t.clearTimeout(o.timer), i.proxy)) {
                                    var n = e.src;
                                    return e = new Image, o.img = e, e.src = n, void a(e.src, e, o)
                                }
                                _.numLoaded++, _.numFailed++, o.succeeded = !1, e.onerror = e.onload = null, s()
                            }
                        }
                        var g, b, v, w, _ = {
                                numLoaded: 0,
                                    ...
                                    if (!_.cleanupDone) {
                                        ...
                                        for (c in _)
                                            if (_.hasOwnProperty(c) && (a = _[c], "object" == typeof a && a.callbackname && a.succeeded === n)) {
                                                ...
                                                a.script && a.script.parentNode && (a.script.setAttribute("src", "about:blank"), a.script.parentNode.removeChild(a.script)), _.numLoaded++, _.numFailed++, o("html2canvas: Cleaned up failed img: '" + c + "' Steps: " + _.numLoaded + " / " + _.numTotal)
                                            }
                                        t.stop !== n ? t.stop() : e.execCommand !== n && e.execCommand("Stop", !1), e.close !== n && e.close(), _.cleanupDone = !0, r && "string" == typeof r || s()
                                    }
                                },
                                renderingDone: function() {
                                    w && t.clearTimeout(w)
                                }
                            }, i.timeout > 0 && (w = t.setTimeout(b.cleanupDOM, i.timeout)), o("html2canvas: Preload starts: finding background-images"), _.firstRun = !0, f(x), o("html2canvas: Preload: Finding images"), v = 0; T > v; v += 1) b.loadImage(k[v].getAttribute("src"));
                        return _.firstRun = !1, o("html2canvas: Preload: Done."), _.numTotal === _.numLoaded && s(), b
                        ...
                        function i() {
                            ...
                            if (r === !1) return !1;
                            i.width = i.height = 10, t.src = ["data:image/svg+xml,", "<svg xmlns='http://www.w3.org/2000/svg' width='10' height='10'>", "<foreignObject width='10' height='10'>", "<div xmlns='http://www.w3.org/1999/xhtml' style='width:10;height:10;'>", "sup", "</div>", "</foreignObject>", "</svg>"].join("");
                            try {
                                r.drawImage(t, 0, 0), i.toDataURL()
                            } catch (s) {
                                return !1
                            }
                        ...
                        function r() {
                            var t, n, o, i, r = !1;
                            return e.createRange && (t = e.createRange(), t.getBoundingClientRect && (n = e.createElement("boundtest"), n.style.height = "123px", n.style.display = "block", e.body.appendChild(n), t.selectNode(n), o = t.getBoundingClientRect(), i = o.height, 123 === i && (r = !0), e.body.removeChild(n))), r
                        }
                        return {
                            rangeBounds: r(),
                        ...
                        return s = d.Util.Extend(n, s), d.logging = s.logging, s.complete = function(t) {
                    ...
                    }, t.html2canvas.log = o, t.html2canvas.Renderer = {
                        Canvas: n
    ...
    n || require(["plugins/swfobject", "soutu/js/tu"], function(t, e) {
        if (/^\/imgsearch/.test(location.pathname)) {
            ...
            n.each(function() {
                var t = $(this),
                    e = t.attr("tpl");
                "tu_relate_site" === e && (e += "@" + t.find(".op-tu-relate-site-result").length), o.push(e)
            }), e.log({
    ...
    }(location.href.match(/voice=1/) || navigator.userAgent.match(/mac os x/i)) && require(["plugins/swfobject", "voice/js/voice"], function(e, n) {
